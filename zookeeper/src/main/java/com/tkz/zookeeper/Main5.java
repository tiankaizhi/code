...
public class Main5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        children.forEach(new Consumer<ChildData>() {
            @Override
            public void accept(ChildData childData) {
        ...
        cache.getListenable().addListener(new TreeCacheListener() {
            @Override
            public void childEvent(CuratorFramework c, TreeCacheEvent event) throws Exception {
